...
In this assignment you will you will first implement run-length encoding (RLE). You will then implement the Burrows-Wheeler Transform. The BWT should then be combined with RLE to create a hybrid compression. Please follow the guidelines located in the README.md. 
